    ...
    public function up()
    {
        Schema::create('hc_companies_addresses', function(Blueprint $table) {
            ...
            $table->string('employee_id',
                36)->nullable()->index('fk_hc_companies_addresses_hc_companies_employees1_idx');
            $table->string('country_id', 36);
            $table->string('municipality_id',
                36)->nullable()->index('fk_hc_companies_addresses_hc_regions_municipalities1_idx');
            $table->string('city_id', 36)->nullable()->index('fk_hc_companies_addresses_hc_regions_cities1_idx');
            $table->string('street');
